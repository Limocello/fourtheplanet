...
Scores the sustainability disclosure of 396 S&P 500 companies on how much of the text is corporate and sustainability boilerplate. It does not measure how sustainable a company is. It measures how much of the writing is language rather than information.

486 documents, 9.5 million words. Everything needed to query them is in this folder.
...
|---|---|---|
| `main` | 367 | The company's sustainability or ESG report. |
...
- Companies with no report in the corpus say so rather than showing a zero. The page carries 501 companies and the corpus covers 396 of them.
...
| `data/companies.csv` | Ticker, name, website and GICS sector for each of the 396. |
...
The corpus is 12.0 million tokens over 73 000 distinct words. Re-scoring all 252 terms across all 486 documents takes **0.15 seconds**, about 8 000 times faster than scanning. A new wildcard such as `steward*` takes 11 milliseconds, most of it spent asking the vocabulary which words start with "steward".
